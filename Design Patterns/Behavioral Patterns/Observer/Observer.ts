...
class ConcreteSubject implements Subject {
    /**
     * @type {number} For the sake of simplicity,
     * the Subject's sate, essential to all
     ...
     * In real life, the list of subscribers 
    ...
    /**
     * Usually, the subscription logic is only 
     * a fraction of what a Subject can really do.
     * Subjects commonly hold some important 
     * business logic, that triggers a notification
     * method whenever something important is
...
/**
 * Concrete Observers react to updates issued by
