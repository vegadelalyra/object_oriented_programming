...
class Subject (ABC):
    """
    The Subject interface declares 
    ...
    def detach(self, observer: Observer) -> None:
        """
        Detach an observer from the subejct.
        """
        pass
...
class ConcreteSubject(Subject):
    ...
    essential to all subscribers, is stored
    in this variable.
    """
    ...
    def some_bussiness_logic(self) -> None:
        ...
        hold some important business logic, that triggers a
        notification method whenever something important is
...
class ConcreteObserverB(Observer):
    def update(self, subject: Subject) -> None:
        if subject._state == 0 or subject._state >= 2:
            print('Concrete ObserverB: Reacted to the event')
